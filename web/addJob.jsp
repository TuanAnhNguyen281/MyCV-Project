...
<html lang="en">
    <head>
        ...
        <title>Đăng tải công việc</title>
    ...
    <body>
        ...
        <section id="addjob" class="py-4">
            <div class="container">
                <h2 class="text-center">Đăng Tin Tuyển Dụng</h2>
                <form action="JobManageServlet" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="salary">Lương (Đơn vị VND)</label>
                            <input type="number" class="form-control" id="salary" name="salary" required>
                        </div>
                    </div>
                    <input type="submit" value="Đăng Tin" name="Submit" class="btn btn-primary" />
                </form>
            </div>
        </section>
