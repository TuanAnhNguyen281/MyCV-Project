                            ...
                            <tbody>
                                <c:forEach items="${applicationList}" var="application">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ApplicationServlet?action=updateStatus&applicationId=${application.applicationid}&newStatus=Đồng ý"
                                               class="btn btn-sm btn-success" onclick="return confirm('Bạn có chắc chắn muốn Đồng ý ứng tuyển?');">Đồng ý</a>
                                            <a href="ApplicationServlet?action=updateStatus&applicationId=${application.applicationid}&newStatus=Từ chối"
                                               class="btn btn-sm btn-danger" onclick="return confirm('Bạn có chắc chắn muốn Từ chối ứng tuyển?');">Từ chối</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
